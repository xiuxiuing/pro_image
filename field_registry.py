...
FIELD_ALIASES: Dict[str, List[str]] = {
    ...
    "库存": [
        "库存", "库存量", "可售库存", "当前库存", "剩余库存", "门店库存",
        "商品库存", "库存数", "库存数量", "可售数量", "available_stock", "stock",
    ],
    "月销量": [
    ...
    "A尺寸": ["A尺寸", "尺寸", "规格尺寸", "尺码", "大小", "A尺码", "商品尺寸"],
    "A品牌": ["A品牌", "品牌", "商品品牌", "品牌名", "商标", "A商标", "brand", "Brand"],
    "A型号": ["A型号", "型号", "货号", "款号", "model", "Model", "A款号", "商品型号"],
    "A核心品类": ["A核心品类", "核心品类", "核心类目", "商品核心品类", "A品类"],
    "A商品形态": ["A商品形态", "商品形态", "形态", "商品类型形态", "A形态"],
    "A关键属性词": ["A关键属性词", "关键属性词", "关键属性", "商品关键属性", "A关键属性"],
    "A多维尺寸": ["A多维尺寸", "多维尺寸", "长宽高", "长宽高尺寸", "结构化尺寸", "A长宽高"],
}
